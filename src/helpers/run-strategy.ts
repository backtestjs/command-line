...
export async function run(runParams: RunStrategy) {
  ...
  const strategyPath = isJS
    ? `./dist/strategies/${runParams.strategyName}.js`
    : `./src/strategies/${runParams.strategyName}.ts`;
